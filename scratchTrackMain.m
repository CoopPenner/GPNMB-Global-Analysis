...
vidObj = VideoReader('/Volumes/PC60/iMicroVids/WT_ScratchAssay_6_6_25_allChannels_Scale/WT_Scratch_aB (6).mp4');
...
% signedVelocityTotal=cell(1,length(centroidCatch));
...
% signed_velocity_um_per_min=signed_velocity*pxSize/frameRate;
    ...
    velocitySummary = [velocitySummary; table( ...
        ...
        speedTotal{bb}=velocity_um_per_min;
        signedVelocityTotal{bb}=signed_velocity_um_per_min;
end
